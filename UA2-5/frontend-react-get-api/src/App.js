...
export const UserContext = createContext(null); //contexto criado para propagar o estado entre os componentes

function App() {

  const [JWTAuth, setJWTAuth] = useState(null); //token de acesso para autorizar as rotas
  const [userName, setUserName] = useState(null); //nome de estado
  ...
  return (
    <BrowserRouter>
      ...
      <UserContext.Provider value={{ JWTAuth, setJWTAuth, userName, setUserName }}> {/* Contexto que propaga os estados - usuario */}
        <Routes>
