...
export default async function Home() {
  ...
  //const tasks: Task[] = TaskController.getUserTask(session?.user?.email || ''); // poderia fazer diretamente assim estando do lado do servidor sem precisar acessar uma rota de api
  return (
    <main className='flex flex-col justify-stretch gap-2 p-2'>
